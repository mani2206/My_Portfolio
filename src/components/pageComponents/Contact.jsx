    ...
    <>
      <div className="contact">
        ...
        <div className="contact-cards">
          <div className="contact-card1"  data-aos="flip-up">
            <img
              className="email"
            ...
            />
            <a
              href="mailto:mani220696@gmail.com ? subject = Happy day"
              className="text-decoration-none text-dark text-lowercase"
            >
              mani220696@gmail.com
            </a>
          </div>
          <div className="contact-card2"  data-aos="flip-up">
            <img
              className="mobile"
