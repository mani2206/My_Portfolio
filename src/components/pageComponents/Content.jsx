    ...
    project: [
      {
        ...
        link3: "https://www.codewars.com/users/Manikandan_S",
      },
    ],
  };
    ...
    <>
      ...
      >
        <div>
          ...
          <h5 data-aos="fade-up">
            And I'm a<span className="About_text px-1">{text}</span>
          ...
          <div className="d-flex text-center">
            ...
            <a
              target="_blank"
              href={firstProject.link1}
              className=" mx-2 linkedin"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
            ...
            >
              <svg
                ...
                height="20"
                fill="currentColor"
                className="bi bi-code color_linked"
                viewBox="0 0 16 16"
              >
